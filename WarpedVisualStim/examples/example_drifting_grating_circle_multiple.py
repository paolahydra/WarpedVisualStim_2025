...
ds = DisplaySequence(log_dir=ds_log_dir, is_by_index=True, display_screen=1)
dgc = stim.DriftingGratingMultipleCircle(monitor=mon, indicator=ind, background=0.,
                                 coordinate='degree', center_list=[(10., 20.),(-10., 100.)], sf_list=(0.02,),
                                 tf_list=(10.0, 2.0), dire_list=(180.,90.,), con_list=(0.8,), radius_list=(20.,),
                                 block_dur=1., midgap_dur=1., iteration=2, pregap_dur=1.,
